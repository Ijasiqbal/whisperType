...
(function () {
  ...
  const purple = new THREE.Color('#c45d3e');
  const cyan = new THREE.Color('#d4845a');
  ...
  for (let i = 0; i < COUNT2; i++) {
    ...
    const c = new THREE.Color().lerpColors(new THREE.Color('#d4845a'), new THREE.Color('#facdb4'), 0.3 + Math.random() * 0.3);
    col2[i * 3] = c.r;
    col2[i * 3 + 1] = c.g;
    col2[i * 3 + 2] = c.b;
